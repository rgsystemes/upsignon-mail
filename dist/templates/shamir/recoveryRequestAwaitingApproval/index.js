...
const Template = async ({ vaultEmail = 'someone@septeo.com', expiryDate = new Date(Date.now() + 6 * 24 * 3600 * 1000), requestDate = new Date(), deviceName = 'Device name', deviceType = 'Device type', locale = 'fr', ianaTimezone = 'Europe/Paris', }) => {
