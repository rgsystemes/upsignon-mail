...
const TrialsTable = ({ trials, expiredCase, locale, ianaTimezone, }) => {
    const intl = useIntl();
    return (_jsxs("table", { style: {
            ...
            borderBottom: '2px solid black',
                    ...
                    .map((trial, i) => (_jsxs("tr", { style: { background: i % 2 === 0 ? '#E7E7E7' : '#fff' }, children: [_jsx("td", { style: { padding: '8px', textAlign: 'center' }, children: trial.id }), _jsx("td", { style: { padding: '8px', textAlign: 'center' }, children: trial.name }), _jsx("td", { style: { padding: '8px', textAlign: 'center' }, children: trial.reseller }), _jsx("td", { style: { padding: '8px', textAlign: 'center' }, children: trial.nbUsers }), _jsx("td", { style: { padding: '8px', textAlign: 'center' }, children: formatDateWithMonthName(trial.createdAt, locale, ianaTimezone) }), _jsx("td", { style: {
                                padding: '8px',
                                textAlign: 'center',
                                ...(expiredCase ? { color: 'red' } : {}),
                            }, children: trial.remainingDays })] }, trial.id))) })] }));
};
const SalesSection = ({ salesTrials, locale, ianaTimezone, }) => {
    const intl = useIntl();
    const salesName = salesTrials.sales
        ? salesTrials.sales.replace('@septeo.com', '')
        : intl.formatMessage({ id: 'unassigned' });
    return (_jsxs("div", { children: [_jsx("h3", { children: salesName }), salesTrials.expired.length > 0 && (_jsxs("div", { children: [_jsx("span", { children: intl.formatMessage({ id: 'sectionExpired' }) }), _jsx(TrialsTable, { trials: salesTrials.expired, expiredCase: true, locale: locale, ianaTimezone: ianaTimezone }), _jsx("br", {})] })), salesTrials.next7Days.length > 0 && (_jsxs("div", { children: [_jsx("span", { children: intl.formatMessage({ id: 'section7Days' }) }), _jsx(TrialsTable, { trials: salesTrials.next7Days, locale: locale, ianaTimezone: ianaTimezone }), _jsx("br", {})] })), salesTrials.next14Days.length > 0 && (_jsxs("div", { children: [_jsx("span", { children: intl.formatMessage({ id: 'section14Days' }) }), _jsx(TrialsTable, { trials: salesTrials.next14Days, locale: locale, ianaTimezone: ianaTimezone }), _jsx("br", {})] }))] }));
};
const Template = ({ salesTrials = [], locale = 'fr', ianaTimezone = 'Europe/Paris', }) => {
    const sorted = [...salesTrials].sort((a, b) => (a.sales < b.sales ? -1 : 1));
    return (_jsx(Layout, { messages: messages[locale], locale: locale, children: _jsxs(Section, { className: "text-text-primary px-4", children: [_jsx(Text, { className: "text-base", children: _jsx(FormattedMessage, { id: "hello" }) }), sorted.map((salesTrials) => (_jsx(SalesSection, { salesTrials: salesTrials, locale: locale, ianaTimezone: ianaTimezone }, salesTrials.sales))), _jsx(Text, { className: "text-base", children: _jsx(FormattedMessage, { id: "footer1" }) }), _jsx(Text, { className: "text-base", children: _jsx(FormattedMessage, { id: "footer2" }) })] }) }));
};
